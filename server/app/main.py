...
# Explicitly allow the requested Vercel production/preview origins and local development origins
...
app.add_middleware(
    ...
    allow_origin_regex=r"https://resume-.*-vansh1513s-projects\.vercel\.app",
